...
import { volumes, VolumeData } from "@/data/year3";

export default function Year3SelectPage() {
            ...
            >
                    ...
                    {viewMode === "detailed" ? (
                        ...
                        >
                            {volumes.map((vol) => (
                                ...
                                >
                                    {/* Header Row */}
                                    <div className="grid grid-cols-[60px_1fr] md:grid-cols-[100px_1fr_1fr_300px] bg-gradient-to-r from-emerald-900/40 to-black border-b border-white/10 divide-x divide-white/10 text-center">
                        ...
                        >
                            {volumes.map((vol) => (
                                ...
                                <Link href={`/select/year-3/${vol.id}`} key={vol.id} className="flex flex-col gap-2 group cursor-pointer relative">
                            ...
                            {/* Placeholder  for Future Volumes */}
                ...
                >
                    <Button
                        ...
                        className="rounded-full w-14 h-14 bg-emerald-600 hover:bg-emerald-700 text-white shadow-[0_0_20px_rgba(16,185,129,0.5)] border border-emerald-400/20 flex items-center justify-center transition-all duration-300"
                    >
